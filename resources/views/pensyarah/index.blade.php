	            ...
	            <div class="table-scrollable table-scrollable-borderless">
	                {!! Form::open(['method'=>'POST', 'action'=>'LecturerController@applyLeave', 'files'=>true]) !!}
				        <div class="form-group col-md-12">
				            ...
				            <div class="col-md-8">
				                    <textarea name="reason" class="form-control border-grey-navy" rows="5" placeholder="Nyatakan sebab untuk keluar kampus"></textarea>
				            </div>
				        </div>
				        ...
				        <div class="form-group col-md-12">
				            ...
				            <div class="col-md-8">
				                <input class="form-control input-line" type="file" name="attachment" id="fileToUpload">
				            </div>
				        </div>
				        <div class="form-group col-md-12">
